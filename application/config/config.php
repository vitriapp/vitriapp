<?php
$identify = yaml_parse_file(__DIR__.'/parameter_db.yml', 0);
$data = yaml_parse_file(__DIR__ . '/parameter_db.yml', $identify['identify']);
/**
 * Configuration
 *
 ...
 */
define('DB_TYPE', $data['type']);
define('DB_HOST', $data['server']);
